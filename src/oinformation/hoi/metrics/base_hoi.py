...
from oinformation.hoi.utils.logging import logger, set_log_level
...
class HOIEstimator(object):
    def __init__(self, x, clustered_labels_to_neurons = None, y=None, multiplets=None, verbose=None):
        set_log_level(verbose)
        self._x = self._prepare_data(x, y=y, clustered_labels_to_neurons = clustered_labels_to_neurons, multiplets=multiplets)
    ...
    def _prepare_data(self, x, y=None, multiplets=None, clustered_labels_to_neurons = None):
        """Check input x shape."""
        ...
        self.clustered_labels_to_neurons = clustered_labels_to_neurons
